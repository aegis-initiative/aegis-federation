...
`aegis-governance/federation/` and `aegis-governance/site/src/content/docs/federation/` is being migrated/redirected
to this repository.
...
- Specification source markdown lives under `site/src/content/docs/`. Frontmatter requires `title`; `description`
  is recommended.
