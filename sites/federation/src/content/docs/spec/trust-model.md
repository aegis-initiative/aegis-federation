...
**Document**: GFN-1/Trust (/spec/trust-model/)\
...
- [RFC-0001](https://aegis-governance.com/rfc/0001/): AEGIS Architecture and trust boundaries (in aegis-governance)
- [RFC-0004](/rfc/0004/): Governance Event Model and federation events
- [Network](/spec/network/): network topology and protocol
- [Node Reference Architecture](/spec/node-architecture/): node deployment and trust anchors
...
[^2]: F. B. Schneider, "Enforceable Security Policies," *ACM Transactions on Information and System Security*, vol. 3, no. 1, pp. 30–50, Feb. 2000, doi: 10.1145/353323.353382. See [REFERENCES](https://aegis-governance.com/references/).
