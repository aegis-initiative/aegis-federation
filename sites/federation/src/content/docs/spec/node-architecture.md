...
**Document**: GFN-1/Nodes (/spec/node-architecture/)\
...
- Support policy language: AEGIS Policy DSL (EBNF defined in [RFC-0003](https://aegis-governance.com/rfc/0003/))
...
- Maintain trust scores for known publisher DIDs using the 5-factor model from the [Trust Model](/spec/trust-model/)
...
- [Trust Model](/spec/trust-model/) - Trust scoring and bootstrap mechanisms
- [RFC-0004 Governance Event Model](/rfc/0004/) - Event envelope schemas
- [AEGIS Governance Protocol (AGP-1)](https://aegis-governance.com/protocol/) - Wire protocol specification (in aegis-governance)
...
[^1]: J. P. Anderson, "Computer Security Technology Planning Study," Deputy for Command and Management Systems, HQ Electronic Systems Division (AFSC), Hanscom Field, Bedford, MA, Tech. Rep. ESD-TR-73-51, Vol. II, Oct. 1972. See [REFERENCES](https://aegis-governance.com/references/).

[^4]: S. Rasthofer, S. Arzt, E. Lovat, and E. Bodden, "DroidForce: Enforcing Complex, Data-centric, System-wide Policies in Android," *2014 Ninth International Conference on Availability, Reliability and Security (ARES)*, Fribourg, Switzerland, 2014, pp. 40–49, doi: 10.1109/ARES.2014.13. See [REFERENCES](https://aegis-governance.com/references/).

[^17]: National Institute of Standards and Technology, *Zero Trust Architecture*, NIST SP 800-207, Aug. 2020. [Online]. Available: <https://doi.org/10.6028/NIST.SP.800-207>. See [REFERENCES](https://aegis-governance.com/references/).
