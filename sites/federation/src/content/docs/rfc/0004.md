...
Downstream of [RFC-0001](https://aegis-governance.com/rfc/0001/) through [RFC-0003](https://aegis-governance.com/rfc/0003/). The event model enables federation between compliant GFN-1 runtimes but does not modify the local governance cycle defined in RFC-0001 and RFC-0002.
